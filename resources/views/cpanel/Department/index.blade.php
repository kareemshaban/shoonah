...
<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        ...
        @include('layouts.sidebar' , ['slag' => 4 , 'subSlag' => 42])
        <!-- / Menu -->
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div style="display: flex ; justify-content: space-between ; align-items: center">
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light">{{__('main.product_department')}} /</span> {{__('main.departments')}}
                        </h4>
                    ...
                    <!-- Responsive Table -->
                    <div class="card">
                        <h5 class="card-header">{{__('main.departments')}}</h5>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                @foreach($departments as $department)
                                    <tr>
                                        ...
                                        <td class="text-center">{{$department -> name_ar}}</td>
                                        <td class="text-center">{{$department -> name_en}}</td>
                                        ...
                                        <td class="text-center">
                                            <div style="display: flex ; gap: 10px ; justify-content: center ">
                                                <i class='bx bxs-edit-alt text-success editBtn' data-toggle="tooltip" data-placement="top" title="{{__('main.edit_action')}}"
                                                   id="{{$department -> id}}" style="font-size: 25px ; cursor: pointer"></i>
...
@include('cpanel.Department.create')
@include('cpanel.Department.deleteModal')
...
<script type="text/javascript">
    ...
    function confirmDelete(id){
        let url = "{{ route('deleteDepartment', ':id') }}";
