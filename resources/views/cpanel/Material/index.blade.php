...
<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        ...
        @include('layouts.sidebar' , ['slag' => 5 , 'subSlag' => 51])
        <!-- / Menu -->
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div style="display: flex ; justify-content: space-between ; align-items: center">
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light">{{__('main.material_list')}} /</span> {{__('main.materials')}}
                        </h4>
                    ...
                    <!-- Responsive Table -->
                    <div class="card">
                        <h5 class="card-header">{{__('main.materials')}}</h5>
...
@include('cpanel.Material.create')
@include('cpanel.Material.deleteModal')
    ...
    $(document).on('click', '#createButton', function (event) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $(".modal-body #unit_id").val(0);
                $(".modal-body #priceOfHundred").val(0);
                ...
                if(response){
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            $(".modal-body #description_en").val(response.description_ar);
                            $(".modal-body #unit_id").val(response.unit_id);
                            $(".modal-body #priceOfHundred").val(response.priceOfHundred);
