<div class="modal fade" id="myalertModal" tabindex="-1" role="dialog" aria-labelledby="smallModalLabel" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-start">
                        <button type="button" class="btn btn-labeled btn-warning cancel-modal2"  >
                            <span class="btn-label" >{{__('main.iAgreeBtn')}}</span></button>
                    </div>
                </div>
            </div>
        </div>
