<div class="modal fade" id="blockModal" tabindex="-1" role="dialog" aria-labelledby="smallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background: #F8F8F8 ; border-radius: 8px">
                <label class="modelTitle"> {{__('main.block_title')}}</label>
            ...
            <div class="modal-body" id="smallBody">
                <div style="display: flex ; align-items: center">
                    ...
                    <label class="alertTitle">{{__('main.block_alert')}}</label>
                </div>
                ...
                <div class="row">
                    <div class="col-6 text-center">
                        <button type="button" class="btn btn-labeled btn-success btnConfirmDelete1" >
                            <span class="btn-label" ><i class="bx bx-check"></i></span>{{__('main.confirm_btn')}}</button>
                    </div>
                    <div class="col-6 text-center">
                        <button type="button" class="btn btn-labeled btn-warning cancel-modal1"  >
